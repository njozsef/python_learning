...
class seasons:
    def __init__(self):
        ...
        self.tvdb_key = 'RTM3RDZGMjAyMTA1MTRCQQ=='
    ...
    def seasonDirectory(self, items):
        ...
        trailerMenu = control.lang(32361).encode('utf-8')
    ...
    def episodeDirectory(self, items):
        ...
        for i in items:
            try:
                ...
                cm.append((control.lang(32361).encode('utf-8'), 'RunPlugin(%s?action=trailer&name=%s)' % (sysaddon, systvshowtitle)))
