...
class channels:
    ...
    def items_list(self, i):
        try:
            ...
            self.list.append({'title': title, 'originaltitle': originaltitle, 'year': year, 'genre': genre, 'duration': '0', 'rating': rating, 'votes': votes, 'mpaa': mpaa, 'director': director, 'writer': writer, 'cast': cast, 'plot': plot, 'code': imdb, 'imdb': imdb, 'tmdb': '0', 'poster': poster, 'channel': i[2], 'num': i[3]})
        except:
            pass
    ...
    def channelDirectory(self, items):
        ...
        for i in items:
            try:
                ...
                systitle = urllib.quote_plus(i['originaltitle'])
                ...
                cm.append((control.lang(32360).encode('utf-8'), 'RunPlugin(%s?action=trailer&name=%s)' % (sysaddon, sysname)))
